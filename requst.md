...
2. 要求：
  - 代码结构请借鉴并尽可能遵循程序设计架构要求；达到代码结构可维护性和可扩展性。
...
这是card的一些静态属性。资源文件在    目录: D:\Mycardgame\Mycardgame\Resources\res
number，suits，card_general.png  牌的背景是cardgeneral，中间是number/bignumber，右上角是suit花色，左上角是number/smallnumber  
